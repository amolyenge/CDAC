...
public class ProductDaoImpl implements ProductDao{
	...
	static {
		...
		try {
			...
			findprod=conn.prepareStatement("select * from myproducts");
			...
			deleteById=conn.prepareStatement("delete from myproducts where pid=?");
			sortByPrice=conn.prepareStatement("select * from myproducts order by price");
