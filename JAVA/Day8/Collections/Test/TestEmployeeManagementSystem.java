...
public class TestEmployeeManagementSystem {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 7->{
				System.out.println("enetr sal for delete");
				double sal=sc.nextDouble();
			...
			case 8->{
				System.out.println("eneter salary for searching");
				double sal=sc.nextDouble();
				List<Employee> elst=eservice.findBySalary(sal);
				if(elst!=null) {
					elst.forEach(System.out::println);
				}else{
					System.out.println("not found");
			...
			case 9->{
				System.out.println("eneter salary for sort");
				double sal=sc.nextDouble();
				List<Employee> elst=eservice.sortBySalary(sal);
				if(elst!=null) {
					elst.forEach(System.out::println);
				}else{
					System.out.println("not found");
