namespace Demo_LINQ_01
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //var evenResult = _Even(num);
            //var oddResult = _Odd(num);

            //Console.WriteLine($"For no = {num} --> Even: {evenResult}, Odd: {oddResult}");
            #endregion
            ...
            //Func<string> func2 = delegate () { return "Hugh Jackman"; };        
            //var result2 = func2();
