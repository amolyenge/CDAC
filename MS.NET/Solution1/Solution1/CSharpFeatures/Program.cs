...
namespace CSharpFeatures
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine($"Add Result = {cmath.Add(10,30)}");
            //Console.WriteLine($"Multiply Result = {cmath.Multiply(10, 2)}");
            #endregion

            #region Nullable Types [ ? = Nullable operator]
            //string name = null;
            //int deptID = null;  //not null
            //int? deptID = null;   // value type can hold null if we use nullable operator (?)
            //int? deptID = 232323;
            //if (deptID.HasValue)
            //{
            ...
            //Demo demo = new Demo() { _name = nm, _description = des };
            //Console.WriteLine($"Name = {demo._name}, Description= {demo._description}");
            #endregion
